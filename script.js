...
cmdInput.addEventListener('keydown', async (event) => {
    if (event.key === 'Enter') {
        ...
        outputDiv.innerHTML += '<br><br>' + `<span class="nema" style="color: #fff";>NEMA</span><span style="color: #fff"> |</span></span><span style="color: red">$ </span>` + `<span class="command" style="color: white;"> ${command}</span>`;
...
if (command === 'who is he?') {
    const alertMessage = 'He is a mysterious figure. Beware of his secrets! His name start with A. To know more WhatsApp me! I am whole day working I could not even programmed this IBRAIN terminal. Actuall this IBRAIN terminal is for techie who want to learn to know about IBRAIN you can type "ibrain"';
...
else if (command === 'tell me please') {
        const nematellmepleaseResponse = 'I know who is crush on you.\n Type: \n - Who is he?\n - I am not interested on crush\n - I hate those thing\n - I am going to study only\n - I hate it\n - I dont care those thing\n -\n -\n - \n -\n- Love is blind...';
        simulateTerminalResponse(nematellmepleaseResponse);
    }
    
    else if (command === 'who is he' || command === 'who is he') {
        const nemaaskwhoisheResponse = 'Are you sure? Type \n - Sure \n- Not sure';
        simulateTerminalResponse(nemaaskwhoisheResponse);
    } else if (command === 'who is he?') {
    const alertMessage = 'He is a mysterious figure. Beware of his secrets! His name start with A. To know more WhatsApp me! I am whole day working I could not even programmed this IBRAIN terminal. Actuall this IBRAIN terminal is for techie who want to learn to know about IBRAIN you can type "ibrain"';
    window.alert(alertMessage);
}


else if (command === 'ignore' || command === 'I am not interested on crush' || command === 'i hate those thing' || command === 'i am going to study only' || command === 'i hate it' || command === 'i dont care those thing') {
        const nemaignoreResponse = 'Oh! I cant proceed further more. I respect your life and your decisions!';
        simulateTerminalResponse(nemaignoreResponse);
    }
